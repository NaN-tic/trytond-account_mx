...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        tax_unpaid_line = [l for l in invoice.move.lines if l.account == account_tax][0]
        tax_line = [l for l in lines if l.account == account_tax][0]
        paid_line = [l for l in lines if l.account == account_client_tax_paid][0]
        self.assertEqual(tax_unpaid_line.debit, Decimal('0'))
        self.assertEqual(tax_unpaid_line.credit, Decimal('10.00'))
        self.assertEqual(tax_line.debit, Decimal('10.00'))
        self.assertEqual(tax_line.credit, Decimal('0'))
        self.assertEqual(paid_line.debit, Decimal('0'))
        self.assertEqual(paid_line.credit, Decimal('10.00'))